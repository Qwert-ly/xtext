# 说明
- `ctext - all - slice`：自主收集的文言文繁体语料库，主要爬取自[维基文库](zh.qikisource.org)、[全上古三代秦漢三國六朝文](zh.wikisource.org/wiki/全上古三代秦漢三國六朝文)、[漢川草廬](www.sidneyluo.net)等处
- `ctext - 副本 - 副本`：`ctext - all - slice`的先秦部分
- `ctext - 白话`：自主收集的白话及现代汉语繁体语料库，主要爬取自[维基百科](zh.wikipedia.org)、[BWIKI](wiki.biligame.com)、[维基文库](zh.qikisource.org)、[知乎](www.zhihu.com)、[繁體中文書庫](www.bwsk.net)等处
